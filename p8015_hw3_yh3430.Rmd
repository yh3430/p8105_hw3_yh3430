...
The figure of day_id over activity_day did not show any special trend of daily activity. However, activity distributed closely around 4e+05 from day 10 to day 20.
...
activity_plot = 
  ...
  ggplot(aes(x = activity_minute, y = activity_count, group = activity_minute, color = day)) +
    geom_line(alpha = .5) +
    viridis::scale_color_viridis(
    name = "Counties",
    discrete = TRUE
